...
from model.VAN_FC import VAN_FCFormer
import sys
...
parser.add_argument('--base_lr', type=float,  default=0.01,  # 0.01会出现梯度爆炸 不清楚为什么
...
Net = VAN_FCFormer(img_size=args.img_size, num_classes=1, pretrain=args.is_pretrain).to(device)
